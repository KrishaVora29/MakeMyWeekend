                        ...
                        <div className="chat-container">
                            <div className="chat-messages">
                                <div className="message user1">
                                    <span className="sender"><FaUserAlt/></span>
                                    <span className="message-content">Hey, any plans for the weekend?</span>
                                </div>
                                <div className="message user3">
                                    <span className="sender"><FaUserAlt/></span>
                                    <span className="message-content">check out MakeMyWeekend, It's an amazing website for weekend ideas!</span>
                                </div>
                                <div className="message user1">
                                    <span className="sender"><FaUserAlt/></span>
                                    <span className="message-content">Yes, I have heard of it.</span>
                                </div>
                                <div className="message user2">
                                    <span className="sender"><FaUserAlt/></span>
                                    <span className="message-content">It has a wide range of ideas for all interests.</span>
                                </div>
                                <div className="message user1">
                                    <span className="sender"><FaUserAlt/></span>
                                    <span className="message-content">I just loved it !</span>
                                </div>
