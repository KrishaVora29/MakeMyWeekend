                    ...
                    <div className='headingimg'>
                        ...
                        <div className="abc2">
                            <ul className='navbar-main'>
                                <li><NavLink to="/Homepage/Homepage" activeClassName="active">Home</NavLink></li>
                                <li><NavLink to="/feed/feed" activeClassName="active">Feed</NavLink></li>
                                <li><NavLink to="/MyPosts/MyPosts" activeClassName="active">My Posts</NavLink></li>
                                <li><NavLink to="/Users/List/User" activeClassName="active">Users</NavLink></li>
                                <li><NavLink to="/About/About" activeClassName="active">About</NavLink></li>
